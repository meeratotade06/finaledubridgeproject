...
//			driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(8000));
		...
		public void buyProduct()
		{
			...
			searchBox.sendKeys("Fossile watches for women",Keys.ENTER);
			String parentWindow=driver.getWindowHandle();
			WebElement watches=driver.findElement(By.xpath("(//a[@class=\"a-link-normal s-no-outline\"])[1]"));
			watches.click();
			...
			username.sendKeys("meeratotade06@gmail.com");
			WebElement continurBtn=driver.findElement(By.id("continue"));
			continurBtn.click();
			WebElement password=driver.findElement(By.id("ap_password"));
			password.sendKeys("mee&sarayu2017");
