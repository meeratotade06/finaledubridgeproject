package amazontest;
	...
	public class SearchForProduct {
		...
		public void searchProduct()
		{
			...
			WebElement fossile=driver.findElement(By.xpath("(//span[@class=\"a-size-base-plus a-color-base\"])[1]"));
			String text=fossile.getText();
			Assert.assertTrue(text.equals("fossile"));
		}
		@AfterSuite
